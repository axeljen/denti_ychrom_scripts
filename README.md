This directory contains scripts used in our manuscript "Breaking the rule: An exceptional Y chromosome introgression between deeply divergent primate species" (Jensen et al. 2024).
